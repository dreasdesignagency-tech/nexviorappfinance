    ...
    <header className="flex items-center justify-between mb-5 md:mb-6 gap-3 md:gap-4 flex-nowrap px-0 pl-12 md:pl-0 md:px-0 min-w-0">
      ...
      <div className="flex items-center gap-2.5 md:gap-3 shrink-0 self-center">
        <NavLink
          ...
          className="w-10 h-10 rounded-full glass-inner flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors"
        >
        ...
        <NavLink
          to="/perfil"
          aria-label="Perfil"
          className="md:hidden w-10 h-10 rounded-full bg-gradient-to-br from-primary to-accent ring-2 ring-border hover:ring-primary/50 transition-all flex items-center justify-center text-xs font-bold text-primary-foreground overflow-hidden shrink-0"
        >
          {profile.avatar ? (
